...
sub translations {
    ...
    'tree' => {
        ...
        'Malayalam'  => [ 'naːraŋːa' ],
        'Swedish'    => [ 'apelsinträd' ],
        'Arabic' => [ 'شجرة البرتقال', 'šájarat al-burtuqál' ],
        'Sindhi' => [ 'نارنگيءَ جو وَڻُ', 'narangi’a ju vanu' ],
        'Danish' => [ 'appelsintræ' ],
        'Esperanto'     => [ 'oranĝarbo',      'oranĝujo' ],
        'Malay'         => [ 'pokok limau' ],
        'Luxembourgish' => [ 'Orangëbam' ],
        ...
        'Macedonian'    => [ 'портокал' ],
        'Low German'    => [ 'Orange' ],
        'Kurdish'       => [ 'pirteqal',        'دار پرته‌قاڵ' ],
        'Belarusian' => [ 'apelsínavaie dréva' ],
        'Italian'    => [ 'arancio' ],
        'Roman'      => [ 'narandža', 'pomorandža', 'naranča', 'pomoranča' ]
    },
    'colour' => {
        'Hawaiian'   => [ 'ʻalani' ],
        'French'     => [ 'orange' ],
        'Greek'      => [ 'πορτοκαλί', 'πορτοκαλής' ],
        'Lithuanian' => [ 'oranžinė' ],
        'Kyrgyz'     => [ 'токсары' ],
        'Georgian'   => [ 'სტაფილოსფერი' ],
        'Malay'      => [ 'jingga' ],
        'Bengali'    => [ 'কমলা' ],
        'German'     => [ 'Orange', 'orange' ],
        'Swahili'    => [ 'rangi ya machungwa' ],
        'Romanian'   => [ 'portocaliu', 'oranj' ],
        'Maltese'    => [ 'oranġjo' ],
        'Thai'       => [ 'ส้ม' ],
        'Slovene'    => [ 'oranžna', 'oranžen' ],
        'Irish'      => [ 'oráiste' ],
        'Persian'    => [ 'نارنجی' ],
        'Welsh'      => [ 'oren', 'melyngoch' ],
        'Vietnamese' => [ 'da' ],
        'Polish'     => [ 'pomarańczowy', 'pomarańcz' ],
        'Montagnais' => [ 'kaishkuteushit' ],
        'Turkish'    => [ 'turuncu' ],
        'Armenian'   => [ 'նարնջագույն', 'գազարագույն' ],
        'Hungarian' =>  [ 'narancssárga', 'narancs szín', 'narancs', 'narancsszínű' ],
        'Basque'     => [ 'laranja' ],
        'Tuvan'      => [ 'кызыл-сарыг' ],
        'Czech'      => [ 'oranžový' ],
        'Macedonian' => [ 'портокалова', 'портокалов' ],
        'Bulgarian'  => [ 'оранжев', 'портокалов' ],
        'Khmer'      => [ 'ទឹកក្រូច', 'ពណ៌លឿង' ],
        'Zulu'       => [ 'orenji' ],
        'Yiddish'    => [ 'מאַראַנץ' ],
        'Roman'      => [ 'narandžasta', 'narančasta', 'narandžast' ],
        'Russian'    => [ 'оранжевый' ],
        'Latin'      => [ 'aurantius', 'aurantia', 'aurantium', 'arantius' ],
        'Norwegian'  => [ 'oransje' ],
        'Lojban'     => [ 'narju' ],
        ...
        'Arabic'     => [ 'برتقالي' ],
        'Buryat'     => [ 'шара улаан' ],
        'Swedish'    => [ 'orange',     'brandgul',       'apelsinfärgad' ],
        'Sindhi'        => [ 'نارنگِي',     'narangi' ],
        'Danish'        => [ 'orange' ],
        'Esperanto'     => [ 'oranĝokolora' ],
        'Ukrainian'     => [ 'оранжевий', 'помаранчевий' ],
        ...
        'Urdu'      => [ 'نارَنْگی', 'نارنگی' ],
        'Japanese' => [ 'orenjiiro', 'daidaiiro', 'オレンジ色', '橙色' ],
        'Icelandic' => [ 'appelsínugulur' ],
        'Cyrillic'  => [ 'наранџаста', 'наранџаст' ],
        'Volapük'  => [ 'rojanik' ],
        'Kazakh'    => [ 'қызғылт сары' ],
        'Finnish'   => [ 'oranssi' ],
        'Navajo'    => [ 'łichxíʼí' ],
        'Chechen'   => [ 'цlеран бос' ],
        'Turkmen'   => [ 'narýnç', 'mämişi' ],
        'Azeri'     => [ 'narincı' ],
        'Marathi'   => [ 'नारिंगी' ],
        'Nama'      => [ 'oranje' ],
        ...
        'Mandarin'               => [ '橙色', '橙黃色', '橙黄色' ],
        'Tamil'                  => [ 'செம்மஞ்சள்' ],
        'Dutch'                  => [ 'oranje', 'brandgeel', 'geelrood' ],
        'Low German'      => [ 'Orange',         'orange' ],
        ...
        'Egyptian Arabic' => [ 'برتقاني', 'برتقالي' ],
    ...
    'fruit' => {
        ...
        'Persian'    => [ 'نارنج', 'پرتقال' ],
        'Welsh'      => [ 'oren' ],
        'Vietnamese' => [ 'cam', 'quả', 'trái' ],
        'Sotho'      => [ 'lamunu' ],
        'Polish'     => [ 'pomarańcza' ],
        'Turkish'    => [ 'portakal' ],
        'Tajik'      => [ 'афлесун', 'норанҷ' ],
        'Armenian'   => [ 'նարինջ' ],
        'Hungarian'  => [ 'narancs' ],
        'Basque'     => [ 'laranja' ],
        'Tatar'      => [ 'äflisun' ],
        ...
        'Hindi'      => [ 'नारंगी', 'संतरा' ],
        'Manx'       => [ 'oranje' ],
        'Arabic'     => [ 'برتقالة', 'collective', 'برتقال' ],
        'Swedish'    => [ 'apelsin' ],
        'Sindhi'        => [ 'نارنگِي',     'narangi' ],
        'Danish'        => [ 'appelsin' ],
        'Esperanto'     => [ 'oranĝo' ],
        ...
        'Estonian'      => [ 'apelsin' ],
        'Hebrew'        => [ 'תפוז' ],
        'Indonesian'    => [ 'jeruk manis',        'limau' ],
        'Telugu'        => [ 'నారింజ', 'కమలాఫలము' ],
        'Korean'        => [ '오렌지' ],
        'Mongolian'     => [ 'жүрж' ],
        'Spanish'   => [ 'naranja',      'china', 'Dominican Republic' ],
        'Urdu'      => [ 'نارنگی', 'سنترا' ],
        'Japanese'  => [ 'みかん',    'オレンジ' ],
        'Bashkir'   => [ 'әфлисун' ],
        'Icelandic' => [ 'appelsína' ],
        ...
        'Turkmen'  => [ 'narynç' ],
        'Azeri'    => [ 'portağal' ],
        'Marathi'  => [ 'संत्रे', 'नारिंग' ],
        'American Sign Language' => [ 'C@NearChin Squeeze' ],
        'Mandarin'               => [
            '橙', '橙子',
            'technically "tangerine", but often used as "orange"',
            '橘子', 'alternative form:', '桔子'
        ],
        'Dutch'      => [ 'sinaasappel', 'appelsien' ],
        'Low German' => [ 'Orange' ],
        'Tagalog'         => [ 'kahel',    'dalandan', 'narangha' ],
        'Kurdish'         => [ 'pirteqal', 'پرته‌قاڵ' ],
        'Kalmyk'          => [ 'зүрҗ' ],
        'Belarusian'      => [ 'апэльсін' ],
        'Scottish Gaelic' => [ 'oraindsear' ],
        'Egyptian Arabic' => [ 'برتقان', 'collective' ],
        'Italian'         => [ 'arancia' ]
    }
};
