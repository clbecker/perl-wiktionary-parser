...
=head1 Methods for Wiktionary::Parser
...
=item B<new>
	...
	Optional Args:
	my $parser =Wiktionary::Parser->new(
		wiktionary_url => '...' # optional - url to wiktionary api - defaults to and currently only supports content from en.wiktionary.org
	);
...
=head1 Methods for Wiktionary::Parser::Document
...
=head1 Methods for Wiktionary::Parser::Section
...
=head1 Methods for Wiktionary::Parser::Section::Translations
...
=head1 Methods for Wiktionary::Parser::Section::Translations::WordSense
...
=head1 Methods for Wiktionary::Parser::Section::Translations::WordSense::Lexeme
